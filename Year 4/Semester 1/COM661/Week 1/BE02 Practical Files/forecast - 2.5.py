...
for forecast in json_data['list']:
    ...
    print("\nCurrent weather in " + json_data['city']['name']) # adds location to output
    print(timestamp + " : " + temperature +  " : " + description)
    print("Sunset at " + time_converter( json_data['city']['sunset'] ) + " and sunrise at " + time_converter( json_data['city']['sunrise'] ) )    # sunset and sunrise